...
@EnableJpaRepositories(entityManagerFactoryRef = "commonEntityManagerFactory", transactionManagerRef = "commonTransactionManager",
        basePackages = {"com.system.repositories"}, repositoryFactoryBeanClass = RepositoryFactoryBean.class)
...
public class JpaCommonConfig {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory(EntityManagerFactoryBuilder builder) {
        return builder.dataSource(dataSource).properties(jpaProperties.getHibernateProperties(dataSource)).packages("com.support.domain.entity").build();
    }
