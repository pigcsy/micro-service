 ...
 */
package com.system.domain.request.resource;
...
@AllArgsConstructor
@NoArgsConstructor
public class ResourcesListRequestDto extends BasePageRequest {
    ...
    public ResourcesListRequestDto(int currentPage, int pageSize) {
