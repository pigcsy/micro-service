 ...
 */
@Data
public class EditResourceResponseListVo extends BaseResponse implements Comparable<EditResourceResponseListVo> {
    private List<EditResourceResponseListVo> subMenu;
    ...
    public EditResourceResponseListVo(Integer resourceId, String name, String url, Byte sort, String page) {
        super();
    ...
    @Override
    public int compareTo(EditResourceResponseListVo o) {
