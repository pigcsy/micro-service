...
public interface BaseRepository<T, ID extends Serializable> extends JpaRepository<T, ID>, JpaSpecificationExecutor<T>, JpaRepositoryExt<T, ID> {
    /**
     * 加锁
     *
     * @param id
     ...
     * @return
     */
    <X> Page<X> find(final String hql, final String countHql, final Map<String, ?> params, Pageable pageable, Class<X> clazz);
     ...
     * @return
     */
    <X> Page<X> findByNative(final String sql, final String countSql, final List<?> params, Pageable pageable, Class<X> clazz);
